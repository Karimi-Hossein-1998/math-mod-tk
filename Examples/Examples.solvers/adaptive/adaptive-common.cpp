...
#include "../../../includes/solvers/ODE/adaptive/adaptive-common.hpp"
...
int main()
{
    ...
    SolverResults results_rk12 = rk12_solver(params);

    std::cout << "Solving via rk23...\n";
    SolverResults results_rk23 = rk23_solver(params);

    std::cout << "Solving via rk34...\n";
    SolverResults results_rk34 = rk34_solver(params);

    std::cout << "Solving via rk45...\n";
    SolverResults results_rk45 = rk45_solver(params);
    ...
    std::string         filename = "common-adaptive-methods-comparison";
...
// > g++ -O3 -std=c++23 adaptive-common.cpp -o adaptive-common.exe
// > ./adaptive-common.exe